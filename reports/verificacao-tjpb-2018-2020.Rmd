---
title: "Verificação dos Dados de Remuneração do TJPB de 2018 a 2020"
...
### Verificando colunas
#### Agency ID
Todas as linhas possuem um valor para a coluna **aid**, e ele é sempre igual a "tjpb".
```{r echo = FALSE, message = FALSE, warning = FALSE, cache = FALSE, paged.print = FALSE}
aid <- dados_filtrados %>%
  summarise(atende = all(aid == "tjpb") & n() > 0)

aid$atende
```
#### Month
O valor de **month** é maior que 0 e menor que 13 em todas as linhas do TJPB (o json diz que o mínimo deve ser 0, e o máximo 12, possível erro)
```{r echo = FALSE, message = FALSE, warning = FALSE, cache = FALSE, paged.print = FALSE}
...
```
#### Year
O valor de **year** é igual a 2018, 2019 ou 2020 em todas as linhas do TJPB (o json diz que o mínimo deve ser 0, possível erro(?))
```{r echo = FALSE, message = FALSE, warning = FALSE, cache = FALSE, paged.print = FALSE}
...
```
#### Name
Todas as linhas do TJPB possuem um valor para a coluna **name** 
```{r echo = FALSE, message = FALSE, warning = FALSE, cache = FALSE, paged.print = FALSE}
...
```
#### Role
Todas as linhas do TJPB possuem um valor para a coluna **role**
```{r echo = FALSE, message = FALSE, warning = FALSE, cache = FALSE, paged.print = FALSE}
...
Os tipos presentes no TJPB são: "servidor", "membro". Cumprem a restrição.
```{r echo = FALSE, message = FALSE, warning = FALSE, cache = FALSE, paged.print = FALSE}
distribuição_dos_tjpb <- dados_filtrados %>% 
  filter(aid == "tjpb") %>% 
  group_by(type) %>% 
  count() %>%
  pull(type)

distribuição_dos_tjpb %>%
  knitr::kable()
```

Todas as linhas do TJPB possuem um valor para a coluna **type**
```{r echo = FALSE, message = FALSE, warning = FALSE, cache = FALSE, paged.print = FALSE}
...
```
#### Income Total
Todas as linhas do TJPB possuem um valor maior ou igual a 0 para a coluna **income_total**
```{r echo = FALSE, message = FALSE, warning = FALSE, cache = FALSE, paged.print = FALSE}
...
```
#### Perks Total
Todas as linhas do TJPB possuem um valor maior ou igual a 0 para a coluna **perks_total**
```{r echo = FALSE, message = FALSE, warning = FALSE, cache = FALSE, paged.print = FALSE}
...
```
#### Sum of all funds
Todas as linhas do TJPB possuem um valor maior ou igual a 0 para a coluna **funds_total**
```{r echo = FALSE, message = FALSE, warning = FALSE, cache = FALSE, paged.print = FALSE}
...
```
#### Total discounts
Todas as linhas do TJPB possuem um valor maior ou igual a 0 para a coluna **discounts_total**
```{r echo = FALSE, message = FALSE, warning = FALSE, cache = FALSE, paged.print = FALSE}
